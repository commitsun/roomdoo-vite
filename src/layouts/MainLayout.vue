...
import LeftDrawerSlide from '@/components/leftDrawer/LeftDrawerSlide.vue';
import LeftDrawerFixed from '@/components/leftDrawer/LeftDrawerFixed.vue';
import FoliosList from '@/components/folios/FoliosList.vue';
import FolioComponent from '@/components/folios/FolioComponent.vue';
import PartnerDetail from '@/components/partners/PartnerDetail.vue';
import AutocompleteMobile from '@/components/roomdooComponents/AutocompleteMobile.vue';
import TransactionDetailMobile from '@/components/transactions/TransactionDetailMobile.vue';
...
import BookingEngine from '@/components/bookingEngine/BookingEngine.vue';
