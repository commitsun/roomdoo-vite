...
import CheckinFlowCustomerSearch from '@/legacy/components/checkinFlow/CheckinFlowCustomerSearch.vue';
...
import CheckinFlowAddressOptions from '@/legacy/components/checkinFlow/CheckinFlowAddressOptions.vue';
