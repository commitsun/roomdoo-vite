...
import type SplittedReservationBorderInterface from '@/legacy/interfaces/SplittedReservationBorderInterface';

import TooltipRestriction from '@/legacy/components/planningReservations/TooltipRestriction.vue';
