...
import type { PartnerSaleLines } from '@/legacy/interfaces/PartnerSaleLines';
import type { PartnerTransactions } from '@/legacy/interfaces/PartnerTransaction';

import TransactionCharges from '@/legacy/components/transactions/TransactionCharges.vue';
import DownPaymentInvoiceChanges from '@/legacy/components/transactions/DownPaymentInvoiceChanges.vue';
import TransactionComponent from '@/legacy/components/transactions/TransactionComponent.vue';
import FolioDirectPaymentLink from '@/legacy/components/folios/FolioDirectPaymentLink.vue';
