...
import type { DailyBillingInterface } from '@/legacy/interfaces/DailyBillingInterface';
import type { DailyFreeRoomsInterface } from '@/legacy/interfaces/DailyFreeRoomsInterface';
import type { AlertsPerDayInterface } from '@/legacy/interfaces/AlertsPerDayInterface';
import type { PayloadReservationLineChangeInterface } from '@/legacy/interfaces/PayloadReservationLineChangeInterface';
import type { PlanningReservationLineInterface } from '@/legacy/interfaces/PlanningReservationLineInterface';
import type {
