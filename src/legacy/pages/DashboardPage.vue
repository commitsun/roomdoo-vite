...
import DashboardGreetingCell from '@/legacy/components/dashboard/DashboardGreetingCell.vue';
import DashboardPropertyOperativeCell from '@/legacy/components/dashboard/DashboardPropertyOperativeCell.vue';
import DashboardLastReservationsReceivedCell from '@/legacy/components/dashboard/DashboardLastReservationsReceivedCell.vue';
import DashboardDonutChartSaleChannels from '@/legacy/components/dashboard/DashboardDonutChartSaleChannels.vue';
import DashboardDonutChartRoomStates from '@/legacy/components/dashboard/DashboardDonutChartRoomStates.vue';
import DashboardFeedPosts from '@/legacy/components/dashboard/DashboardFeedPosts.vue';
import DashboardLineChart from '@/legacy/components/dashboard/DashboardLineChart.vue';
