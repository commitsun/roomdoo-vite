...
import InvoiceDialog from '@/legacy/components/invoices/InvoiceChanges.vue';
...
import { useInvoices } from '@/legacy/utils/useInvoices';
import { dialogService } from '@/legacy/services/DialogService';
import { useStore } from '@/legacy/store';
import InvoiceMailComponent from '@/legacy/components/mails/InvoiceMailComponent.vue';
