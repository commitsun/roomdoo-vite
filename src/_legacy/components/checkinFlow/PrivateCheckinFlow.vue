...
import CheckinFlowStart from '@/_legacy/components/checkinFlow/CheckinFlowStart.vue';
import ReservationSegmentation from '@/_legacy/components/reservations/ReservationSegmentation.vue';
import CheckinFlowEntryType from '@/_legacy/components/checkinFlow//CheckinFlowEntryType.vue';
import CheckinFlowPhotoTake from '@/_legacy/components/checkinFlow/CheckinFlowPhotoTake.vue';
import CheckinFlowPhotoConfirm from '@/_legacy/components/checkinFlow/CheckinFlowPhotoConfirm.vue';
import CheckinFlowPhotoComplete from '@/_legacy/components/checkinFlow/CheckinFlowPhotoComplete.vue';
import CheckinFlowCustomerSearch from '@/_legacy/components/checkinFlow/CheckinFlowCustomerSearch.vue';
import CheckinFlowCountry from '@/_legacy/components/checkinFlow/CheckinFlowCountry.vue';
import CheckinFlowDocumentType from '@/_legacy/components/checkinFlow/CheckinFlowDocumentType.vue';
import CheckinFlowDocumentNumber from '@/_legacy/components/checkinFlow/CheckinFlowDocumentNumber.vue';
import CheckinFlowDocumentSupportNumber from '@/_legacy/components/checkinFlow/CheckinFlowDocumentSupportNumber.vue';
import CheckinFlowName from '@/_legacy/components/checkinFlow/CheckinFlowName.vue';
import CheckinFlowBirthdate from '@/_legacy/components/checkinFlow/CheckinFlowBirthdate.vue';
import CheckinFlowRelationship from '@/_legacy/components/checkinFlow/CheckinFlowRelationship.vue';
import CheckinFlowGender from '@/_legacy/components/checkinFlow/CheckinFlowGender.vue';
import CheckinFlowStreet from '@/_legacy/components/checkinFlow/CheckinFlowStreet.vue';
import CheckinFlowAddress from '@/_legacy/components/checkinFlow/CheckinFlowAddress.vue';
import CheckinFlowContact from '@/_legacy/components/checkinFlow/CheckinFlowContact.vue';
import CheckinFlowAddressOptions from '@/_legacy/components/checkinFlow/CheckinFlowAddressOptions.vue';
import CheckinFlowSummary from '@/_legacy/components/checkinFlow/CheckinFlowSummary.vue';
import CheckinFlowFeedback from '@/_legacy/components/checkinFlow/CheckinFlowFeedback.vue';
import CheckinCardFlow from '@/_legacy/components/checkinFlow/CheckinCardFlow.vue';
import CheckinFlowFingerSign from '@/_legacy/components/checkinFlow/CheckinFlowFingerSign.vue';
import CheckinFlowStepper from '@/_legacy/components/checkinFlow/CheckinFlowStepper.vue';
import {
  useCheckinPartner,
  DEFAULT_CHECKIN_PARTNER_VALUES,
} from '@/_legacy/utils/useCheckinPartner';
