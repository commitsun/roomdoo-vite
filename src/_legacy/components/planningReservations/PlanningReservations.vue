...
import type SplittedReservationBorderInterface from '@/_legacy/interfaces/SplittedReservationBorderInterface';

import TooltipRestriction from '@/_legacy/components/planningReservations/TooltipRestriction.vue';
import CustomIcon from '@/_legacy/components/roomdooComponents/CustomIcon.vue';

import utilsDates, { localeSpain, ONE_DAY_IN_MS } from '@/_legacy/utils/dates';
