...
import { useContactsStore } from '@/infrastructure/stores/contacts';import AutocompleteComponent from '@/_legacy/components/roomdooComponents/AutocompleteComponent.vue';
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      amount.value =
        !props.isEdit && !props.isRefund ? props.chargeAmount ?? 0 : transaction.value?.amount ?? 0;
      if (props.isEdit) {
