                ...
                v-if="
                  ...
                  !(
                    currentReservations?.filter(
                      (el: ReservationInterface) => el.isSplitted || el.stateCode === 'cancel',
...
import FolioInternalComments from '@/_legacy/components/folios/FolioInternalComments.vue';
import PartnerComments from '@/_legacy/components/partners/PartnerComments.vue';
import ReservationComponent from '@/_legacy/components/reservations/ReservationComponent.vue';
import ReservationDetail from '@/_legacy/components/reservations/ReservationDetail.vue';
import FolioInfo from '@/_legacy/components/folios/FolioInfo.vue';
import FolioBatchChanges from '@/_legacy/components/folios/FolioBatchChanges.vue';
import FolioOrReservationCancelBlocked from '@/_legacy/components/alerts/FolioOrReservationCancelBlocked.vue';
import FolioMessagesComponent from '@/_legacy/components/folios/FolioMessagesComponent.vue';
...
import {
  ...
  folioStateText,
} from '@/_legacy/utils/folio';
import { dialogService } from '@/_legacy/services/DialogService';
import type { roomTypeClassesInterface } from '@/_legacy/interfaces/roomTypeClassesInterface';
