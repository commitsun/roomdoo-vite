  ...
  <div class="invoice-card">
    ...
    <div v-for="(saleLine, index) in saleLinesWithoutPartner" :key="saleLine.id">
      ...
      >
        ...
        <div
          v-if="
            saleLine.reservationId &&
            !saleLine.serviceId &&
            saleLine.displayType !== 'line_section' &&
            saleLine.displayType !== 'line_note'
          "
          class="sale-line-qty"
        >
        ...
        <div
          v-if="saleLine.displayType !== 'line_section' && saleLine.displayType !== 'line_note'"
          class="sale-line-amount"
        >
  ...
  >
    ...
    >
      ...
      <div
        ...
        v-if="
          draftMoveLine.displayType !== 'line_section' && draftMoveLine.displayType !== 'line_note'
        "
      >
  ...
  <div class="invoice-card" v-for="postedInvoice in postedInvoices()" :key="postedInvoice.id ?? 0">
    ...
    >
      ...
      <div
        class="invoice-line-qty"
        v-if="
          postedMoveLine.displayType !== 'line_section' &&
          postedMoveLine.displayType !== 'line_note'
        "
      >
