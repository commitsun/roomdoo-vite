...
import DashboardGreetingCell from '@/components/dashboard/DashboardGreetingCell.vue';
import DashboardPropertyOperativeCell from '@/components/dashboard/DashboardPropertyOperativeCell.vue';
import DashboardLastReservationsReceivedCell from '@/components/dashboard/DashboardLastReservationsReceivedCell.vue';
import DashboardDonutChartSaleChannels from '@/components/dashboard/DashboardDonutChartSaleChannels.vue';
import DashboardDonutChartRoomStates from '@/components/dashboard/DashboardDonutChartRoomStates.vue';
import DashboardFeedPosts from '@/components/dashboard/DashboardFeedPosts.vue';
