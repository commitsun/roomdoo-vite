...
import ReservationDateChanges from '@/components/reservations/ReservationDateChanges.vue';
...
import ReservationRoomChanges from '@/components/reservations/ReservationRoomChanges.vue';
