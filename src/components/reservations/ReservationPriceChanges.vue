            ...
            <div class="day" v-for="(item, index) in service.items" :key="index">
              <div :class="item.serviceLine ? 'content' : 'empty'">
                <div class="top">
                  ...
                  <span v-if="item.serviceLine" class="price">
                    {{
                      (
                        item.serviceLine.priceUnit *
                        (1 - item.serviceLine.discount / 100) *
                ...
                <div v-if="item.serviceLine" class="down">
                  <div class="input-wrapper">
                    <input type="number" v-model="item.serviceLine.quantity" />
                    <span class="label"> uds.</span>
                  </div>
                  <div class="input-wrapper">
                    <input v-model="item.serviceLine.priceUnit" type="number" />
                  ...
                  <div class="input-wrapper">
                    <input
                      ...
                      "
                    />
                    <span class="label" v-show="service.isDiscountShowedAsPercentage">
                      % dto.
                    </span>
                    <input
                      type="number"
