...
import FolioInternalComments from '@/components/folios/FolioInternalComments.vue';
import ReservationComponent from '@/components/reservations/ReservationComponent.vue';
import ReservationDetail from '@/components/reservations/ReservationDetail.vue';
import FolioInfo from '@/components/folios/FolioInfo.vue';
import FolioBatchChanges from '@/components/folios/FolioBatchChanges.vue';
import FolioOrReservationCancelBlocked from '@/components/alerts/FolioOrReservationCancelBlocked.vue';
import FolioMessagesComponent from '@/components/folios/FolioMessagesComponent.vue';
import FolioTransactions from '@/components/folios/FolioTransactions.vue';
import FolioCheckins from '@/components/folios/FolioCheckins.vue';
import FolioInvoicing from '@/components/folios/FolioInvoicing.vue';
...
import type { roomTypeClassesInterface } from '@/interfaces/roomTypeClassesInterface';
